defmodule DeadGiveawayWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DeadGiveawayWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DeadGiveawayWeb.Gettext, "errors", msg, opts)
    end
  end
