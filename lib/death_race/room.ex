defmodule DeathRace.Room do
  @moduledoc """
  A single Death Race room: one GenServer owning the authoritative `World` for
  the players inside it. Supervised, one per room (DESIGN §9).

  The Room is the stateful shell around the pure `DeathRace.World`: it tracks who
